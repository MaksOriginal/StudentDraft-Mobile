...
export default function StudentScreen(props) {
  ...
  const ToProgressPage = () =>{
    props.navigation.replace('Progress');
  }
      ...
      <View style={styles.userInfoBlock}>
        <View style={styles.userPhotoAndData}> 
          <View style={styles.userPhoto}>
            <Image style={{width: 100, 
                           marginTop: 10,
                           resizeMode: 'contain'}} source={require('../../assets/user.png')} />
          </View>
          <View>
            <View style={styles.userInfoItem}>
              <Text>Каширских</Text>
              <Text>Максим</Text>
              <Text>Дмитриевич</Text>
            </View>
            <View style={styles.userInfoItem}>
              <Text>Студенческий билет</Text>
              <Text style={{fontStyle:'italic'}}>№3170205</Text>
            </View>
            <View style={styles.userInfoItem}>
              <Text>Место учебы</Text>
        ...
        <View style={styles.userRole}>
          ...
          <Text style={{marginLeft: 50, 
                        color: '#8c3e3c',
                        fontStyle: 'italic'}}>Исполнитель</Text>
        </View>
      </View>
