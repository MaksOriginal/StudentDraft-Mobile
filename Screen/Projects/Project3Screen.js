  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.text}>
        ...
        этой цели является создание Web-сайта. Это напрямую связано с тем, что практически любая сфера деятельности, независимо от того связана она с 
