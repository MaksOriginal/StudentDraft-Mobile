          ...
          <Button onPress={()=>{
              ...
              value.then((res) => {
                if(res == null)
                  ...
                  Alert.alert("Заявка успешно подана.")
              })
          }}
            title="Подать заявку"
          />
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titleWrapper}>
        <Text style={styles.title}>Разработка интегральных микросхем</Text>
      </View>
      <ScrollView style={styles.text}>
        ...
        <View style={styles.withContact}>
          <Text>Демидов Р.С.</Text>
          <Text style={styles.contact}>(исполнитель)</Text>
        </View>
        <View style={styles.withContact}>
          <Text>Карлик А.М.</Text>
          <Text style={styles.contact}>(исполнитель)</Text>
        </View>
        <View style={styles.withContact}>
          <Text>Рыженко Ю.А.</Text>
          <Text style={styles.contact}>(исполнитель)</Text>
        </View>
        <View style={styles.withContact}>
        ...
        <Text>
        В короткий срок создать высокоинтегрированные функциональные узлы.</Text>
        ...
        далее в наноэлектронику. {"\n"}Это в свою очередь создает базу интенсивного развития современного общества во
        всех сферах (медицина, информатика, автоматизация техпроцессов и др.). Курсовой проект по дисциплине
        "Проектирование микросхем и микропроцессоров" выполняется с целью закрепления приобретенных при изучении
        курса знаний и получения практических навыков конструирования интегральных микросхем (ИМС).
        </Text>
      </ScrollView>
      <SubscribeButton/>
    </View>
