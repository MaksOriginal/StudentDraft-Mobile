          ...
          <Button onPress={()=>{
              ...
              value.then((res) => {
                if(res == null)
                  ...
                  Alert.alert("Вы участвуете в проекте.")
              })
          }}
            title="Вы участник проекта"
          />
        </View>
      )
    }else{
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titleWrapper}>
        <Text style={styles.title}>Проектирование ИС для организации проектной работы студентов</Text>
      </View>
      <ScrollView style={styles.text}>
        ...
        <View style={styles.withContact}>
          <Text>Галиаскаров Э.Г.</Text>
          <Text style={styles.contact}>(контактные данные)</Text>
        </View>
        <Text style={styles.head}>Вакансии</Text>
        <View style={styles.withContact}>
          <Text>Каширских М.Д.</Text>
          <Text style={styles.contact}>(разработчик мобильного приложения)</Text>
        </View>
        <View style={styles.withContact}>
          <Text>Афанасьева В.П.</Text>
          <Text style={styles.contact}>(разработчик веб-приложения)</Text>
        </View>
        <Text style={styles.head}>Краткая информация о проекте:</Text>
        <Text>
        Разработать мобильное и web-приложение для организации проектной работы студентов  </Text>
        <Text style={styles.head}>Полная информация о проекте:</Text>
        <Text>
        Целью работы является разработка информационной системы с мобильным интерфейсом,
        позволяющая взаимодействовать заказчикам, преподавателям или сотрудникам кафедр
        и студентам для решения актуальных задач, которые имеются у заказчика, путем
        выполнения их студентами в рамках учебного процесса в своей выпускной квалификационной
        или курсовой работе. А также уменьшение нагрузки преподавателей вв сфере выдачи заданий.
        </Text>
      </ScrollView>
      <SubscribeButton/>
    </View>
